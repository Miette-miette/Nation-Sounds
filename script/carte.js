...
let carteCMS= await cms.dataCMS("https://nation-soundswp-am41helgut.live-website.com/wp-json/wp/v2/posts?categories=26");// Carte de Nation Sounds WP 
console.log(carteCMS);

let infoCarte= await cms.dataCMS("https://nation-soundswp-am41helgut.live-website.com/wp-json/wp/v2/posts?categories=28+18&per_page=40");//Informations des lieux et des scènes
